...
Процедура ИсполняемыеСценарии() Экспорт
	...
	ЮТТесты
		.ДобавитьТестовыйНабор("ВставитьПараметрыВСтроку")
			...
			.ДобавитьТест("Тест_ВставитьПараметрыВСтроку_ЭкранированиеПроцента", "Шаблон с экранированием: %% -> %")
...
Процедура Тест_ВставитьПараметрыВСтроку_ЭкранированиеПроцента() Экспорт
