...
Процедура ИсполняемыеСценарии() Экспорт
	...
	ЮТТесты
		...
		.ДобавитьТестовыйНабор("ЗаписатьФорму")
			.ДобавитьКлиентскийТест("Тест_ЗаписатьФорму")
	;
...
#Область ЗаписатьФорму

#Если Клиент Тогда

Процедура Тест_ЗаписатьФорму() Экспорт
	...
	ФормаДокумента = ОткрытьФорму("Документ.ЖЧТ_Документ.Форма.ФормаДокумента");
	ПараметрыЗаписи = Новый Структура("РежимЗаписи");
	
	
	ПараметрыЗаписи.РежимЗаписи = РежимЗаписиДокумента.Проведение;
	Результат = ТестируемыйМодуль.ЗаписатьФорму(ФормаДокумента, ПараметрыЗаписи);
	ЮТест.ОжидаетЧто(Результат, 
		"Проведение с незаполненным обязательным реквизитом").ЭтоЛожь();
	
	
	ПараметрыЗаписи.РежимЗаписи = РежимЗаписиДокумента.Запись;
	Результат = ТестируемыйМодуль.ЗаписатьФорму(ФормаДокумента, ПараметрыЗаписи);
	ЮТест.ОжидаетЧто(Результат, 
		"Запись с незаполненным обязательным реквизитом").ЭтоИстина();
	
	
	ФормаДокумента.Объект.ОбязательныйРеквизит = 1;
	ПараметрыЗаписи.РежимЗаписи = РежимЗаписиДокумента.Проведение;
	Результат = ТестируемыйМодуль.ЗаписатьФорму(ФормаДокумента, ПараметрыЗаписи);
	ЮТест.ОжидаетЧто(Результат, 
		"Проведение с заполненным обязательным реквизитом").ЭтоИстина();
	
	ПараметрыЗаписи.РежимЗаписи = РежимЗаписиДокумента.ОтменаПроведения;
	Результат = ТестируемыйМодуль.ЗаписатьФорму(ФормаДокумента, ПараметрыЗаписи);
	ЮТест.ОжидаетЧто(Результат, 
		"Отмена проведения документа").ЭтоИстина();
	
	ПараметрыЗаписи.РежимЗаписи = РежимЗаписиДокумента.Запись;
	ФормаДокумента.Объект.ВызватьИсключениеПередЗаписью = Истина;
	Результат = ТестируемыйМодуль.ЗаписатьФорму(ФормаДокумента, ПараметрыЗаписи);
	ЮТест.ОжидаетЧто(Результат, 
		"Исключение перед записью").ЭтоЛожь();
	
	
	
	ФормаДокумента.Закрыть();
	ЖЧТ_ОбщееВызовСервера.УдалитьОбъект(ФормаДокумента.Объект.Ссылка);
