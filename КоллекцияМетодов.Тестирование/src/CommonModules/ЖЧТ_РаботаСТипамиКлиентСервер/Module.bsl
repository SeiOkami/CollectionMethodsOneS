		...
		.ДобавитьТестовыйНабор("ИменаСвойствОбъектаМетаданных")
			.ДобавитьСерверныйТест("Тест_ИменаСвойствОбъектаМетаданных")
				.СПараметрами("Справочник.ЖЧТ_ТестовыйСправочник", 
					"Номер,ИмяПредопределенныхДанных,Предопределенный,Ссылка,ПометкаУдаления,Наименование,Код,ТестоваяТЧ")
				.СПараметрами("Справочник.ЖЧТ_ТестовыйСправочник", 
					"ИмяПредопределенныхДанных,Предопределенный,Ссылка,ПометкаУдаления,Наименование,Код", 
