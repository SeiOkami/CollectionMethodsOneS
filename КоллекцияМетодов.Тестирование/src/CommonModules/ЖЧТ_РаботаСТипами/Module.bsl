...
Процедура ИсполняемыеСценарии() Экспорт
	...
	ЮТТесты
		...
		.ДобавитьТестовыйНабор("ЭтоОшибкаСуществованияМетода")
			.ДобавитьТест("Тест_ЭтоОшибкаСуществованияМетода_Добавить")
				// Объект | Ожидаемый результат | Ожидаемый результат без учета необъектного типа
				.СПараметрами(Неопределено   , Истина, Ложь)
				.СПараметрами("Это строка"   , Истина, Ложь)
				.СПараметрами(Новый Структура, Истина, Истина)
				.СПараметрами(Новый Массив   , Ложь  , Ложь)
...
#Область ЭтоОшибкаСуществованияМетода

Процедура Тест_ЭтоОшибкаСуществованияМетода_Добавить(Объект, ОжиданиеСНеобъектным, ОжиданиеБезНеобъектного) Экспорт
	...
	Попытка
		...
		Объект.Добавить(1, 2, 3, 4, 5);
		
	Исключение
		
		ИнформацияОбОшибке = ИнформацияОбОшибке();
		
		Результат = ТестируемыйМодуль.ЭтоОшибкаСуществованияМетода(ИнформацияОбОшибке, "Добавить");
		ЮТест.ОжидаетЧто(Результат).Равно(ОжиданиеСНеобъектным);
		
		Результат = ТестируемыйМодуль.ЭтоОшибкаСуществованияМетода(ИнформацияОбОшибке, "Добавить", Ложь);
		ЮТест.ОжидаетЧто(Результат).Равно(ОжиданиеБезНеобъектного);
		
	КонецПопытки;
	
	Если ИнформацияОбОшибке = Неопределено Тогда
		ВызватьИсключение "Метод Добавить не выдал ошибку, тест невозможно провести";
	КонецЕсли;
