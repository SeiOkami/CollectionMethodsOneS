...
Процедура ИсполняемыеСценарии() Экспорт
	...
	ЮТТесты
		...
		.ДобавитьТестовыйНабор("СсылкаИзНавигационной")
			.ДобавитьТест("Тест_СсылкаИзНавигационной_Успешно")
				.СПараметрами(
					"e1cib/data/Справочник.ЖЧТ_ТестовыйСправочник?ref=a0bd64c901c5c6cb11f160d9113e4ef4",
					"СправочникСсылка.ЖЧТ_ТестовыйСправочник",
					"113e4ef4-60d9-11f1-a0bd-64c901c5c6cb")
			.ДобавитьТест("Тест_СсылкаИзНавигационной_Ошибка")
				.СПараметрами("")
				.СПараметрами("e1cib/data/блабла")
				.СПараметрами("e1cib/data/Справочник.НЕТТАКОГО")
				.СПараметрами(Неопределено)
	;
...
#Область СсылкаИзНавигационной

Процедура Тест_СсылкаИзНавигационной_Успешно(
	Знач GUID, Знач ИмяТипа, Знач ОжидаемыйИдентификатор) Экспорт
	...
	Результат = Модуль.СсылкаИзНавигационной(GUID);
	
	ЮТест.ОжидаетЧто(Результат)
		.ИмеетТип(ИмяТипа);
	
	ЮТест.ОжидаетЧто(Результат.УникальныйИдентификатор())
		.Равно(ОжидаемыйИдентификатор);
	
КонецПроцедуры

Процедура Тест_СсылкаИзНавигационной_Ошибка(Знач GUID) Экспорт
