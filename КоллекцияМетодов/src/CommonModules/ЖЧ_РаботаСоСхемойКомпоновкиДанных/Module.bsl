...
Функция ДобавитьПолеНабораДанных(НаборДанных, Поле, Заголовок = "", ПутьКДанным = "", ТипЗначения = Неопределено) Экспорт
	...
	Если ТипЗнч(ТипЗначения) = Тип("ОписаниеТипов") Тогда
		ПрисвояемыйТипЗначения = ТипЗначения;
	ИначеЕсли ТипЗнч(ТипЗначения) = Тип("Строка") Тогда
		ПрисвояемыйТипЗначения = Новый ОписаниеТипов(ТипЗначения);
	Иначе
		ПрисвояемыйТипЗначения = Новый ОписаниеТипов;
	КонецЕсли;
	НовоеПоле.ТипЗначения = ПрисвояемыйТипЗначения;
