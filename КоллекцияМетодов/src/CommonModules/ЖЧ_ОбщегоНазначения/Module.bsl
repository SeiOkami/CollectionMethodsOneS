...
Функция ЕстьСвойствоОбъекта(Знач Объект, Знач ПутьКСвойству, Значение) Экспорт
	...
	Возврат Ложь; //Если пустая строка 
	
КонецФункции

// Альтернатива одноименного метода запроса
// 
// Источник: 
//  https://github.com/SeiOkami/CollectionMethodsOneS/issues/147
// 
// Параметры:
//  ПроверяемоеЗначение - Произвольный
//  АльтернативноеЗначение - Произвольный
// 
// Возвращаемое значение:
//  Произвольный
//
Функция ЕстьNull(Знач ПроверяемоеЗначение, Знач АльтернативноеЗначение) Экспорт
	
	Если ПроверяемоеЗначение = Null Тогда
		Возврат АльтернативноеЗначение;
	Иначе
...
// 	Формирует УИД формата 
// 		"113e4ef4-60d9-11f1-a0bd-64c901c5c6cb"
// 	из ГУИД (например, из навигационной ссылки) формата 
// 		"a0bd64c901c5c6cb11f160d9113e4ef4"
// 
// Источник: 
//  https://github.com/SeiOkami/CollectionMethodsOneS/issues/169
// 
// Параметры:
//  GUID - Строка
// 
...
// Например, получает ссылку на справочник по ссылке: 
// 		"e1cib/data/Справочник.ЖЧТ_ТестовыйСправочник?ref=a0bd64c901c5c6cb11f160d9113e4ef4"
// Использует см. УникальныйИдентификаторИзGUID
// 
// Источник: 
//  https://github.com/SeiOkami/CollectionMethodsOneS/issues/171
// 
// Параметры:
