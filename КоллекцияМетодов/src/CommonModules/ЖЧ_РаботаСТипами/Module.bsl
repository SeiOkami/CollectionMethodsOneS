...
// Структура свойств объекта.
// 
// Параметры:
//  Объект - Произвольный
// 
// Возвращаемое значение:
//  Структура, Неопределено - Структура со свойствами или Неопределено, если объект не содержится в метаданных
Функция СтруктураСвойствОбъекта(Знач Объект) Экспорт
	...
	ИменаСвойств = ИменаСвойствОбъектаМетаданных(ОбъектМетаданных);
	Результат = Новый Структура(СтрСоединить(ИменаСвойств, ","));
...
Функция ИменаСвойствОбъектаМетаданных(Знач ОбъектМетаданныхИлиПолноеИмя, Знач ПроверяемыеСвойства = "") Экспорт
	...
	Если ПустаяСтрока(ПроверяемыеСвойства) Тогда
		ПроверяемыеСвойства = "Измерения,Ресурсы,Реквизиты,СтандартныеРеквизиты,
		|ТабличныеЧасти,СтандартныеТабличныеЧасти,ОбщиеРеквизиты";
	КонецЕсли;
	...
	Если КоллекцииСвойств.Свойство("ОбщиеРеквизиты") Тогда
		...
		АвтоИспользованиеОбщегоРеквизита = Метаданные.СвойстваОбъектов.АвтоИспользованиеОбщегоРеквизита.Использовать;
		...
		Для Каждого ОбщийРеквизит Из Метаданные.ОбщиеРеквизиты Цикл
			...
			Если ОбъектВСоставе.Использование = ИспользованиеОбщегоРеквизита.Использовать Тогда
				ИспользованиеДляОбъекта = Истина;
			ИначеЕсли ОбъектВСоставе.Использование = ИспользованиеОбщегоРеквизита.НеИспользовать Тогда
				ИспользованиеДляОбъекта = Ложь;
			Иначе
				ИспользованиеДляОбъекта = (ОбщийРеквизит.АвтоИспользование = АвтоИспользованиеОбщегоРеквизита);
			КонецЕсли;
